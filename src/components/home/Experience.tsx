          ...
          <HomeGlassCard key={job.company} delay={i * 0.1} glow={i === 0}>
            <div className="mb-6 flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 font-body text-sm font-medium leading-6 text-electric-400 md:text-base">
                  {job.role}
                </p>
                <p className="font-body text-sm font-medium leading-6 text-electric-400 md:text-base">
                  {job.dates}
                </p>
              </div>
            </div>
            <ul className="space-y-3 border-t border-white/10 pt-6">
              {job.highlights.map((item) => (
                <li
                  key={item}
                  className="flex gap-3 rounded-lg bg-white/[0.02] px-3 py-2.5 font-body text-sm leading-relaxed text-slate-400"
                >
